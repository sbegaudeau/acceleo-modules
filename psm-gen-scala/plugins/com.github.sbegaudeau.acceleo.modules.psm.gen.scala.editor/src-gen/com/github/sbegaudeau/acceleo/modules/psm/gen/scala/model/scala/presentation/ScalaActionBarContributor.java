 ...
 * @generated
 */
public class ScalaActionBarContributor extends
	...
	protected IAction refreshViewerAction = new Action(
			ScalaEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("scala-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("scala-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ScalaEditorPlugin.INSTANCE.getString("_UI_ScalaEditor_menu"), "com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scalaMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
