 ...
 * <ul>
 *   <li>{@link com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scala.impl.ExtendableClassifierImpl#getOwnedComment <em>Owned Comment</em>}</li>
 *   <li>{@link com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scala.impl.ExtendableClassifierImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scala.impl.ExtendableClassifierImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scala.impl.ExtendableClassifierImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scala.impl.ExtendableClassifierImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link com.github.sbegaudeau.acceleo.modules.psm.gen.scala.model.scala.impl.ExtendableClassifierImpl#getTraits <em>Traits</em>}</li>
...
public class ExtendableClassifierImpl extends EObjectImpl implements
	...
	public void setOwnedComment(String newOwnedComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ScalaPackage.EXTENDABLE_CLASSIFIER__OWNED_COMMENT,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ScalaPackage.EXTENDABLE_CLASSIFIER__NAME, oldName, name));
	}
	...
	public EList<Field> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentEList<Field>(Field.class, this,
					ScalaPackage.EXTENDABLE_CLASSIFIER__FIELDS);
		}
		return fields;
	}
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<Method>(Method.class, this,
					ScalaPackage.EXTENDABLE_CLASSIFIER__METHODS);
		}
		return methods;
	}
			...
			if (superType != oldSuperType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ScalaPackage.EXTENDABLE_CLASSIFIER__SUPER_TYPE,
	...
	public EList<Trait> getTraits() {
		if (traits == null) {
			traits = new EObjectResolvingEList<Trait>(Trait.class, this,
					ScalaPackage.EXTENDABLE_CLASSIFIER__TRAITS);
		}
		return traits;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ScalaPackage.EXTENDABLE_CLASSIFIER__METHODS:
			return getMethods();
		case ScalaPackage.EXTENDABLE_CLASSIFIER__SUPER_TYPE:
			if (resolve)
				return getSuperType();
			return basicGetSuperType();
		case ScalaPackage.EXTENDABLE_CLASSIFIER__TRAITS:
			return getTraits();
